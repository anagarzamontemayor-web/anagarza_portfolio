...
|-------|-------------|-----------------|--------|
| 🎬 **Pajarito Aprendiendo a Volar** | Animación principal del proceso de aprendizaje: el pajarito explora, choca con nubes, y gradualmente domina el vuelo hasta alcanzar el sol consistentemente.  | ~1:30 min | [vuelo.mp4](RL_648356.mp4) |
| 📊 **Progreso del Entrenamiento** | Dashboard animado con 4 gráficas que muestran la evolución en tiempo real: recompensa por episodio, tasa de éxito (%), tasa de exploración (ε), y pasos por episodio. | ~2:20 min | [graficas.mp4](descarga.mp4) |
